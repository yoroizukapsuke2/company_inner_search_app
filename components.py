...
def display_initial_ai_message():
    ...
    with st.chat_message("assistant"):
        ...
        st.warning("⚠︎ 具体的に入力した方が期待通りの回答を得やすいです。")
            ...
            # LLMからの回答の場合
                ...
                if message["content"]["mode"] == ct.ANSWER_MODE_1:
                    ...
                    if not "no_file_path_flg" in message["content"]:
                        ...
                        if "main_page_number" in message["content"] and message["content"]["main_page_number"] != 0:
...
def display_search_llm_response(llm_response):
    ...
    if llm_response["context"] and llm_response["answer"] != ct.NO_DOC_MATCH_ANSWER:
        ...
        if "page" in llm_response["context"][0].metadata and llm_response["context"][0].metadata["page"] != 0:
            # ページ番号を取得
        ...
        for document in llm_response["context"][1:]:
            ...
            if "page" in document.metadata and document.metadata["page"] != 0:
                # ページ番号を取得
